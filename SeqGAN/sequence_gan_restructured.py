...
def pre_train_generator(sess, generator, gen_data_loader, likelihood_data_loader, log_file, num_epochs):
    log = open(log_file, 'w')
...
def main():
    ...
    pre_train_generator(sess, generator, gen_data_loader, likelihood_data_loader, log_file, PRE_EPOCH_NUM)
